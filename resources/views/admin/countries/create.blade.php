                ...
                <div class="d-flex">
                    <div class="card flex-fill">
                        <div class="card-header">
                            ...
                            <h5 class="card-title">Davlat qo'shish</h5>
                        </div>


                        <form action="{{ route('countries_admin.store') }}" method="post" enctype="multipart/form-data">
                            @if ($errors->any())
                            ...
                            <div class="row">
                                <div class="col-6">
                                    <h5 class="card-title mb-0">Bayroq rasimi</h5>
