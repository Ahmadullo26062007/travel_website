                ...
                <div class="d-flex">
                    <div class="card flex-fill">
                        <div class="card-header">
                            <h5 class="card-title 0">Countries</h5>
                        ...
                        <table class="table table-bordered table-hover">
                            ...
                            @foreach($countries as $country)
                                <tr>
                                    <td>{{$country->id}}</td>
                                    <td>{{$country->name}}</td>
                                    <td><img width="100px" src="{{asset('images/'.$country->flag)}}" alt="{{$country->name}} Flag"></td>
                                    <td><img width="100px" src="{{asset('images/'.$country->image)}}" alt="{{$country->name}} Image"></td>
                                    <td>
