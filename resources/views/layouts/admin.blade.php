...
<head>
    ...
    <title>Admin Турагенсво "ЧУДЕСНЫЙ МИР"</title>
    ...
    <nav id="sidebar" class="sidebar js-sidebar">
        <div class="sidebar-content js-simplebar">
            <a class="sidebar-brand" href="{{route('admin.index')}}">
                <span class="align-middle">ЧУДЕСНЫЙ МИР</span>
            </a>
                ...
                <ul class="navbar-nav navbar-align">
                    ...
                    <li class="nav-item dropdown">
                        ...
                        <a class="nav-link dropdown-toggle d-none d-sm-inline-block" href="#" data-bs-toggle="dropdown">
                            <img src="{{asset('laravel/public/storage/'.\App\Models\About::find(1)->image)}}" class="avatar img-fluid rounded me-1" alt="Админ"/>
                            <span class="text-dark">Админ</span>
                        </a>
