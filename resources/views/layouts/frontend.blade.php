...
<body id="body" class="home page-template-default page page-id-22853 kochevnik-kg">
    ...
    <noscript><iframe src="https://www.googletagmanager.com/ns.html?id=GTM-KPRF2VH" height="0" width="0"
    ...
    <ul class="fm-links">
        <li class="fm-links__item"><button href="#popup-contacts"
                class="fm-links__btn fm-links__btn--phone js-pop-up-btn"><i class="fa fa-phone"
                    aria-hidden="true"></i>
                <span class="fm-links__text">Позвонить</span></button></li>
        ...
        <li class="fm-links__item fm-links__item--nav"><button
        ...
        <div class="popup__wrap">
            <div class="popup-contacts">
                ...
                <p><small>Офис</small><br><i class="fa fa-phone" aria-hidden="true"></i> <a rel="nofollow"
                        href="tel:+996312986545">+996 (312) 986-545</a></p>
            </div>
        </div>
    </div>
                    ...
                    <form action="/#wpcf7-f33002-o1" method="post" class="wpcf7-form" novalidate="novalidate">
                        ...
                        <div class="form__row"><label><span class="form__label">Имя</span><span
                                    class="wpcf7-form-control-wrap user-name"><input type="text" name="user-name"
                                        ...
                                        aria-invalid="false" placeholder="Имя" /></span></label></div>
                        <div class="form__row"><label><span class="form__label">Телефон</span><span
                                    class="wpcf7-form-control-wrap user-phone"><input type="tel"
                                        ...
                                        placeholder="Номер телефона" /></span></label></div>
