        ...
        <div class="container">
                        ...
                        <nav class="nav header-nav" role="navigation">
                            <ul id="menu-glavnoe-menju" class="menu header-menu">
                                ...
                                <li class="menu__item {{ request()->is('hot-tours') ? 'active' : '' }}"><a
                                        href="{{ route('front.hot_tours.index') }}"
            ...
            <div class="header-mobile">
                ...
                <div id="mobile-nav" class="header-mobile__nav">
                    <button
                        class="header-mobile__nav-btn header-mobile__nav-btn--close js-btn-menu-toggle">Закрыть
                    </button>
...
<ul class="fm-links">
    <li class="fm-links__item">
        <button href="#popup-contacts"
                class="fm-links__btn fm-links__btn--phone js-pop-up-btn"><i class="fa fa-phone"
                                                                            aria-hidden="true"></i>
    ...
    <li class="fm-links__item"><a rel="nofollow"
                                  ...
                                  class="btn fm-links__btn fm-links__btn--wa"><i class="fa fa-whatsapp"
                                                                                 aria-hidden="true"></i> <span
                class="fm-links__text">Написать</span></a></li>

    <li class="fm-links__item fm-links__item--nav">
        <button
            class="js-btn-menu-toggle fm-links__btn fm-links__btn--nav"><i class="fa fa-bars"
